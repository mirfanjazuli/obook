    ...
    <div class="col-lg-4">
        <main class="form-registration w-100 m-auto">
            <form action="/daftar" method="post">
              ...
              <h1 class="h3 mb-3 mt-5 fw-normal text-center">Daftar</h1>
            ...
            <small class="d-block text-center mt-3">Sudah punya akun? <a href="/masuk" style="text-decoration: none">Masuk</a></small>
